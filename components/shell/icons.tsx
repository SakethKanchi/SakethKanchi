/**
 * Brand glyphs. lucide-react v1 dropped third-party brand marks, so the
 * GitHub / LinkedIn logos are inlined here as simple-icons paths. They inherit
 * `currentColor` and take a className like any lucide icon.
 */
