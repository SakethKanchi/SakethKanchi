...
export const profile: Profile = {
  ...
  bio: "Full-Stack Engineer specializing in AI-powered applications and intelligent automation. I build features across React, Node.js, and Python, with hands-on experience architecting RAG systems, LLM integrations, agentic workflows, and developer tools. Shipped a VS Code theme with 10,000+ downloads and led automation teams building AI-driven data pipelines on cloud infrastructure.",
  ...
  openToWork: true,
  stat: { value: "10k+", label: "theme downloads" },
};
